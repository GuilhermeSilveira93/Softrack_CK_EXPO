...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(Escaneamento)/` | `/(Escaneamento)` | `/(Escaneamento)/_layout` | `/_layout` | `/(tabs)/dispositivosSalvos` | `/dispositivosSalvos` | `/(tabs)/envioChecklist` | `/envioChecklist` | `/(tabs)/` | `/(tabs)` | `/(tabs)/_layout`;
  // prettier-ignore
